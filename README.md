...
This repo is the canonical source for Kubernetes Operators that appear on [OKD](https://okd.io).

## Documentation

Full documentation is generated via [mkdoc](https://www.mkdocs.org/) and is located at [https://redhat-openshift-ecosystem.github.io/okd-operators](https://redhat-openshift-ecosystem.github.io/okd-operators)
